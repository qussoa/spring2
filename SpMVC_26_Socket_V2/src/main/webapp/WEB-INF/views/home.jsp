...
<script>
	...
	socket.onopen = function() {
		// 소캣이 서버에 접속이 성공한 다음 최초에 실행될 코드
		let userName = prompt("채팅방 입장 이름을 입력하시오")
	...
	socket.onmessage = function(e) {
		...
		let html = "<div class='from text-left'>"
...
<body>
	...
	<section class="container-fluid">
		<form>
			...
			<div class="form-group">
				<label>받는사람</label> <select id="toList" class="form-control">
			...
			<button id="btn_send" class=" btn btn-success">전송</button>
