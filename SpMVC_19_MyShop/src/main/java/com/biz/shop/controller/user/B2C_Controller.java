...
public class B2C_Controller {
	...
	public String qtyUpdate(@RequestParam("seq") String seq, @RequestParam("p_qty") String p_qty) {
		long longSeq = Long.valueOf(seq);
		int intQty = Integer.valueOf(p_qty);
		int ret = cartService.qtyUpdate(longSeq, intQty);
	...
	public String cart_list_qty_update(CartListVO cartList) {
		...
		log.debug("Cart 수정 : " + cartList.toString());
