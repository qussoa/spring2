...
public class GoogleEnc {
	...
	public static void main(String[] args) {
		...
		String saveFile = "./src/main/webapp/WEB-INF/"
				+ "spring/properties/google.connection.properties";
		
		
		String saveUserName = String.format("google.username=ENC(%s)",
							encUserName);
		String savePassword = String.format("google.password=ENC(%s)",
							encPassword);
		...
		scanner.close();
		System.out.println("google.connection.properties 저장 완료!!!");
