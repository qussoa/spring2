...
<div class="container container-intro">
	...
	<div class="main-story">
		...
		<div class="wow flipInX" data-wow-delay="1.7s">
			<span>#언제나</span> <span>#발전하는</span> <span>#행복한</span> <span>#개발자</span>
		</div>
	</div>
	...
	<div class="wow flipInX" data-wow-delay="2.1s">
		<hr />
	</div>

	<div class="wow flipInX" data-wow-delay="2.3s" data-wow-offset="10">
	...
	<div class="wow flipInX" data-wow-offset="10" data-wow-delay="5.2s">
		<h3 class="text-right">보유기술</h3>
		<h5 class="text-right" id="text-write-title">Spring Framework</h5>
		<p class="text-right" id="text-write-sub">Spring Framewrok 4, 5 기반</p>
		<p class="text-right" id="text-write-sub">MVC 프로젝트 구축</p>
		<p class="text-right" id="text-write-sub">공공 DB OpenAPI 활용 프로젝트 경험</p>
		<p class="text-right" id="text-write-sub">Security 적용 경험</p>
		<h5 class="text-right" id="text-write-title">JavaScript</h5>
		<p class="text-right" id="text-write-sub">Web 환경 인터렉티브 구축 JS 이벤트
			핸들링
		<h5 class="text-right" id="text-write-title">HTML5</h5>
		<p class="text-right" id="text-write-sub">Semantic HTML 5 Web 화면
			구현
		<h5 class="text-right" id="text-write-title">jQuery</h5>
		<p class="text-right" id="text-write-sub">Ajax 활용 RESTFul
			Front-end 개발
		<h5 class="text-right" id="text-write-title">Java</h5>
		<p class="text-right" id="text-write-sub">Java 1.8 기반 프로그래밍 언어
			활용기술
		<h5 class="text-right" id="text-write-title">MY-SQL</h5>
		<p class="text-right" id="text-write-sub">MyBatis DB와 연동하여 동적쿼리 구현
			가능
		<h5 class="text-right" id="text-write-title">Oracle SQL</h5>
		<p class="text-right" id="text-write-sub">Oracle 11g 활용한
			Tablespace, Table, Sequence 작성가능 CRUD
		<p class="text-right" id="text-write-sub">Join, SubQuery 작성가능</p>
		<h5 class="text-right" id="text-write-title">Bootstrap</h5>
		<p class="text-right" id="text-write-sub">반응형 UI 구현 CSS3 HTML5 기반
			CSS 디자인 화면구현
	</div>
</div>
